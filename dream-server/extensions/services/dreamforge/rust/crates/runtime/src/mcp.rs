...
//! MCP (Model Context Protocol) integration layer for DreamForge.
//!
//! Provides server name normalization, tool name prefixing, signature
//! computation, and config hashing used by the MCP client subsystem
//! to manage connections to local and remote MCP tool servers.
