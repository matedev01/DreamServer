...
//! DreamForge telemetry and client identity management.
//!
//! Provides request profiling, client identification headers, and session
//! tracing for DreamForge's local-first inference architecture.
//! Cloud telemetry reporting is disabled by default in local mode.
...
/// When true, telemetry events are kept local and not sent to cloud endpoints.
pub const LOCAL_MODE_DEFAULT: bool = true;

pub const DREAMFORGE_VERSION: &str = env!("CARGO_PKG_VERSION");

pub const DEFAULT_ANTHROPIC_VERSION: &str = "2023-06-01";
pub const DEFAULT_APP_NAME: &str = "dreamforge";
pub const DEFAULT_RUNTIME: &str = "rust";
pub const DEFAULT_AGENTIC_BETA: &str = "dreamforge-20250219";
...
mod tests {
    ...
    fn request_profile_emits_headers_and_merges_body() {
        let profile = AnthropicRequestProfile::new(
            ClientIdentity::new("dreamforge", "1.2.3").with_runtime("rust-cli"),
        )
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("user-agent".to_string(), "dreamforge/1.2.3".to_string()),
                (
                    "anthropic-beta".to_string(),
                    "dreamforge-20250219,prompt-caching-scope-2026-01-05,tools-2026-04-01"
                        .to_string(),
                ),
            ]
        );
